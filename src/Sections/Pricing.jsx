      ...
      <Element name="pricing">
        <div className="container">
          <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
            <AnimatedTitle containerClass="h3 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-14 max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm " title='Flexible pricing for <br /> teams of all sizes.' />
          ...
          <div className="scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6">
            {plans.map((plan, ind) => (
              ...
              >
                ...
                {ind === 1 && (
                  <p className="small-compact mt-9 text-p3 text-center before:content-['-'] before:mx-2.5 after:mx-2.5 after:content-['-']">
                    Limited time offer
                  </p>
                )
                }
